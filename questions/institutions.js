const questionsInstitutions = [
...

    {
        ...
        reponses: [
            "Uniquement un député",
            "Uniquement un sénateur",
            "Tout particulier, directement ou par la procédure de l'exception d'inconstitutionnalité",
            "Uniquement un ministre"
        ],
        bonne: 2,
...

    {
        ...
        reponses: [
            ...
            "L'État leur alloue chaque année une contribution conséquente de développement en plus de leurs ressources propres",
...

    {
        ...
        reponses: [
            "Il nomme les journalistes des médias publics",
            "Il émet des avis techniques et formule des recommandations",
            "Il dirige le ministère de la Communication",
            "Il contrôle les juridictions nationales"
        ],
        bonne: 1,
